...
<div class="container mt-4">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <button class="btn btn-danger mb-3" id="addCurrency">
                ...
                <table class="table table-bordered">
                    <thead class="bg-black text-white">
                        <tr>
                            ...
                            <th class="text-center">Thousand</th>
                        ...
                        @foreach($currencies as $currency)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('currencies.edit', $currency->id) }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <form action="{{ route('currencies.destroy', $currency->id) }}" method="POST" style="display:inline;">
                                        @csrf @method('DELETE')
                                        <button class="btn btn-danger btn-sm" onclick="return confirm('Delete this currency?')">
...
<script>
    document.getElementById('addCurrency').addEventListener('click', function() {
        window.location.href = "{{ route('currencies.create') }}";
    });
</script>
@endsection
