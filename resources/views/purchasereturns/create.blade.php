...
<div class="container">
    ...
    <form action="{{ route('purchase-returns.store') }}" method="POST">
        ...
        <div class="card mb-4 shadow-sm" style="border-radius: 20px">
           ...
           <div class="border p-3 rouded bg-white" style="border-radius: 30px">

        <div class="row mb-3">
            <div class="col-md-4">
                <label for="reference" class="form-label">Reference <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="reference" id="reference" value="PR" required>
            </div>
            <div class="col-md-4">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                <label for="shipping" class="form-label">Shipping Adjustment</label>
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <label for="return_status" class="form-label">Return Status <span class="text-danger">*</span></label>
                <select name="status" id="return_status" class="form-control" required>
            ...
            <div class="col-md-4 mb-3">
                <label for="payment_method" class="form-label">Refund Method <span class="text-danger">*</span></label>
            ...
            <div class="col-md-4 mb-3">
                <label for="amount_paid" class="form-label">Amount Refunded <span class="text-danger">*</span></label>
        ...
        <div class="mb-3">
            ...
            <button type="submit" class="btn btn-danger">Create Purchase Return
...
<template id="product-row-template">
    <tr class="product-row">
        ...
        <td><input type="number" name="product_discount[]" class="form-control product-discount" min="0" value="0" step="0.01"></td>
        <td><input type="number" name="product_tax[]" class="form-control product-tax" min="0" value="0" step="0.01"></td>
        <td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addProductRow(product) {
        ...
        inputs.forEach(input => input.addEventListener('input', () => calculateRowTotal(input.closest('.product-row'))));

        clone.querySelector('.remove-product').addEventListener('click', function() {
            this.closest('.product-row').remove();
            if (document.querySelectorAll('.product-row').length === 0) noProductsRow.style.display = '';
            calculateTotals();
        });
    ...
    searchBtn.addEventListener('click', function() {
        ...
        const foundProducts = products.filter(p => p.name.toLowerCase().includes(searchTerm) || (p.code && p.code.toLowerCase().includes(searchTerm)));
